<footer class="main-footer" style="background-color: #f8f9fa; padding-right: 500px; text-align: left; margin-top:400px;">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <strong style="font-size: 18px; color: #007bff;">Perpustakaan Digital</strong>
        <p style="margin-bottom: 0;">SMK Telkom 1 Medan</p>
      </div>
    </div>
  </div>
</footer>
