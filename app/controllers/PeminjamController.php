...
class PeminjamController extends Controller
{
    ...
    public function cetakPeminjam()
    {
        ...
        $html .= "<tr><th>No</th><th>Peminjaman ID</th><th>User ID</th><th>Buku ID</th><th>Tanggal Peminjaman</th><th>Tanggal Pengembalian</th><th>Status Peminjaman</th></tr>";
        $no = 1;
        foreach ($data as $peminjaman) {
            $html .= "<tr>";
            $html .= "<td>" . $no . "</td>";
            $html .= "<td>" . $peminjaman['PeminjamanID'] . "</td>";
            $html .= "<td>" . $peminjaman['UserID'] . "</td>";
